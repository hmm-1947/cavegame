...
public class VulkanLinePipeline {
    ...
    public void create(VkDevice device, long renderPass) {
        ...
        ByteBuffer vertShader = VulkanUtils.loadShader("/shaders/line.vert.spv");
        ByteBuffer fragShader = VulkanUtils.loadShader("/shaders/line.frag.spv");
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            if (vkCreatePipelineLayout(device, layoutInfo, null, pLayout) != VK_SUCCESS) {
                throw new RuntimeException("Failed to create line pipeline layout.");
            }
            ...
            org.lwjgl.system.Pointer dummy = null;
            ...
            if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, pipelineInfo, null, pPipeline) != VK_SUCCESS) {
                throw new RuntimeException("Failed to create line pipeline.");
            }
